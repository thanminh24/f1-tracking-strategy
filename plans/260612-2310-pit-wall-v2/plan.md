...
|---|-------|--------|----------|
| 00 | [Bug Fixes](phase-00-bug-fixes.md) — home offline, F1 logo, session crash | pending | P0 |
| 10 | [Live/Replay Mode Switcher + Home Redesign](phase-10-live-replay-mode-switcher.md) | pending | P0 |
| 11 | [Race View Redesign — Pit Wall Layout + RL Per-Driver Overlay](phase-11-race-view-redesign-rl-overlay.md) | pending | P0 |
| 12 | [Full Telemetry View — Driver Picker, All Laps, Live-Adaptive](phase-12-full-telemetry-view.md) | pending | P1 |
| 13 | [Race Stats Tab — Multi-Panel RL Insights Dashboard](phase-13-race-stats-tab-rl-insights.md) | pending | P1 |
| 14 | [Track Map Visual Quality + Real F1 Logo](phase-14-track-map-f1-logo-visual-quality.md) | pending | P1 |

### Track B — Incremental Feature Expansion (after Track A)

| # | Phase | Status | Priority |
|---|-------|--------|----------|
| 01 | [Session Clock + Weather Widget](phase-01-session-clock-weather-widget.md) | pending | P1 |
| 02 | [Fastest Lap + Sector Highlights](phase-02-fastest-lap-sector-highlights.md) | pending | P1 |
| 03 | [Team Radio Timeline](phase-03-team-radio-timeline.md) | pending | P1 |
| 04 | [Driver Head-to-Head Card](phase-04-driver-head-to-head-card.md) | pending | P2 |
| 05 | [Pit-Stop Timer Board](phase-05-pit-stop-timer-board.md) | pending | P2 |
| 06 | [Sector Heatmap](phase-06-sector-heatmap.md) | pending | P2 |
| 07 | [DRS Activation Zones on Track Map](phase-07-drs-zones-track-map.md) | pending | P2 |
| 08 | [Position Bump Chart](phase-08-position-bump-chart.md) | pending | P3 |
| 09 | [Keyboard Shortcuts + UX Polish](phase-09-keyboard-shortcuts-ux-polish.md) | pending | P3 |
